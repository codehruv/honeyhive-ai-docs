...
1. Filter your model completions in [HoneyHive](https://app.honeyhive.ai/datasets/generations) using user feedback property that indicates high data quality (eg: "Accepted", "Edit Distance < 10", etc.)
