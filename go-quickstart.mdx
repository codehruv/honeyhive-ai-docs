...
### Feeding OpenAI's inference to HoneyHive

The below example shows how you can ingest the OpenAI input/outputs with additional parameters for `task` and `source` into HoneyHive.

This way you can run the OpenAI call on your side and ingest the response later. Please do track latency on your end if you choose this option.
